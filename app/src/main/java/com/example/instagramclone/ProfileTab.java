...
public class ProfileTab extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (parseUser.get("profileName") != null && parseUser.get("profileBio") != null
                && parseUser.get("profileProfession") != null && parseUser.get("profileHobbies") != null && parseUser.get("profileFavSport") != null) {
            ...
            edtProfileFavoriteSport.setText(parseUser.get("profileFavSport").toString());
        } else {
        ...
        btnUpdateInfo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                parseUser.put("profileFavSport", edtProfileFavoriteSport.getText().toString());
                parseUser.saveInBackground(new SaveCallback() {
                    @Override
                    public void done(ParseException e) {
                        if (e == null) {
                            FancyToast.makeText(getContext(), "Info Update", Toast.LENGTH_LONG, FancyToast.INFO, true).show();
                        } else {
                            FancyToast.makeText(getContext(), "Something is wrong", Toast.LENGTH_LONG, FancyToast.ERROR, true).show();
